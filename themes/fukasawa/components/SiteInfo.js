...
function SiteInfo ({ title }) {
  ...
  return (
        ...
        >
            ...
            <br />
            <span className='text-xs font-serif'> Powered by <a href='https://www.baidu.com' className='underline text-gray-500 dark:text-gray-300'>数字花园 {BLOG.VERSION}</a></span><br /></span>
            <h1>{title}</h1>
        </footer>
  )
}
